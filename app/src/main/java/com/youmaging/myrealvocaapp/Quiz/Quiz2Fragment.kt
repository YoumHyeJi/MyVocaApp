...
class Quiz2Fragment : Fragment() {
    ...
    fun setQuiz(){
        ...
        binding!!.apply {
            ...
            quiz1Quiz.text = items[order].meaning
            ...
            when(right_index){
                0->{
                    quiz1Answer1Btn.setText(items[order].word)
                    quiz1Answer2Btn.setText(items[num1].word)
                    quiz1Answer3Btn.setText(items[num2].word)
                }
                1->{
                    quiz1Answer1Btn.setText(items[num1].word)
                    quiz1Answer2Btn.setText(items[order].word)
                    quiz1Answer3Btn.setText(items[num2].word)
                }
                2->{
                    quiz1Answer1Btn.setText(items[num1].word)
                    quiz1Answer2Btn.setText(items[num2].word)
                    quiz1Answer3Btn.setText(items[order].word)
                }
            }
        }
    }
    ...
    fun playQuiz(num: Int) {
        binding!!.apply {
            if(num<0){
                ...
                if (buttonList[num].text.toString() == items[order].word) {
